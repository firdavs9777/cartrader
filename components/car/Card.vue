...
<template>
	<div
        ...
        <div class="flex h-full" >
         <!-- Change like and dislike button dynamically using click button -->
          <img  class="absolute w-7 right-5 top-2 z-20" :src="favored? heartFilled: heartOutline" alt="favorite" @click="favored = !favored"/>
          <img
            :src="car.url"
            alt=""
